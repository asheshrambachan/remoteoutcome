...
#'   \item{luminosity_sum.*}{Sum of VIIRS nighttime luminosity for years 2012-2021}
#'   \item{luminosity_num_cells.*}{Number of VIIRS grid cells per village for years 2012-2021}
