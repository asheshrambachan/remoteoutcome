...
save(remote_vars_p1, file = "data/remote_vars_p1.rda", compress = "bzip2", compression_level = 2)
save(remote_vars_p2, file = "data/remote_vars_p2.rda", compress = "bzip2", compression_level = 2)
save(remote_vars_p3, file = "data/remote_vars_p3.rda", compress = "bzip2", compression_level = 2)
```
