...
viirs_annual <- zap_labels(viirs_annual)
viirs_annual <- zap_formats(viirs_annual)
for (i in seq_along(viirs_annual)) {
  attr(viirs_annual[[i]], "label") <- NULL
  attr(viirs_annual[[i]], "format.stata") <- NULL
}
