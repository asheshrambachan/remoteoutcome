...
For simplicity, this vignette demonstrate this for a sample of 5 shrids only.
...
- **SHRUG shapefiles**: Download from [devdatalab.org/shrug_download](https://www.devdatalab.org/shrug_download)
- **VIIRS data**: Available through Harvard Dataverse (accessed via API in this vignette)
- **MOSAIKS features**: Queried through the Redivis API

# Step 1: Setup paths and select shrid IDs

```{r shrid_ids}
# Load SHRUG shapefiles (adjust path to your download)
shrug_shapefile <- "../data-raw/shrug-shrid-poly-gpkg/shrid2_open.gpkg"

# Path to save remote_vars
path_to_remote_vars = "../data-raw/remote_vars_5.rda"
